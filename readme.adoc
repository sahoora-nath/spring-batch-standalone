...
![Image of chunk-oriented-processing](https://github.com/sahoora-nath/spring-batch-standalone/tree/master/images/chunk-oriented-processing.png)

=== Configuring a Step

![Image of configuring-a-step](https://github.com/sahoora-nath/spring-batch-standalone/tree/master/images/configuring-a-step.png)
...
![Image of db-output](https://github.com/sahoora-nath/spring-batch-standalone/tree/master/images/Batch_Result.png)
